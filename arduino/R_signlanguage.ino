...
*/
  ...
  //MPU-6050 센서값 매핑
  A_ax = map(A_ax, ax_Max, ax_Min, -90, 90);    //센서를 오른손과 대칭적으로 달아 
  A_ay = map(A_ay, ay_Max, ay_Min, -90, 90);    
  ...
  */
  ...
  String str = "R " + angle1_str + " " + angle2_str + " " + angle3_str + " " + angle4_str + " " + angle5_str 
